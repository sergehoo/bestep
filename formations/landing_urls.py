...
from .views import (
    ...
    CategoryProfessionalCourseDetailView, BusinessInterestRequestCreateView,
)
...
urlpatterns = [
                  ...
                  path(
                      "business/manifestation-interet/",
                      BusinessInterestRequestCreateView.as_view(),
                      name="business_interest_request",
                  ),

                  path("api/public/courses/<int:course_id>/", PublicCourseDetailView.as_view(),
                       name="api_public_course_detail"),

                  path("courses/<slug:slug>-<int:course_id>/", CourseDetailPageView.as_view(),
                       name="course_public_page"),
                  path("public/courses/<int:course_id>/related/", PublicCourseRelatedView.as_view(),
                       name="public_course_related"),

                  path("learner/courses/", LearnerExploreCoursesView.as_view(), name="api_learner_courses_explore"),
                  path("learner/courses/<int:course_id>/", LearnerCourseDetailView.as_view(),
                       name="api_learner_course_detail"),
